    ...
    <div class="landing-top">
      ...
      {phase === 'loading' ? (
        ...
        <section class="hero">
          ...
          <p class="lead">{t('every take is cut at the silence around it. transcription sharpens the cuts and files each take under its script line, so the takes of one line play back to back and you narrow them down over several passes. all from the keyboard.')}</p>
